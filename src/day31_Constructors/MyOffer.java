...
public class MyOffer {
    ...
    public static void main(String[] args) {
        ...
        offer2.setInfo("FL", "Henderson resort", "Bartender", 55000, true,
                true,false, true);

        Offer offer3 = new Offer();
        offer3.setInfo("NY", "Apple Inc", "QA", 125000, true, true,
                true, true);

        Offer offer4 = new Offer();
        offer4.setInfo("CA", "Sony Inc", "QA", 120000, true, false,
                false, true);

        Offer offer5 = new Offer();
        offer5.setInfo("WA","LG Inc", "QE", 127000, true, true,
                true, false);
        ...
        localOffers.removeIf(p -> !p.location.equals("VA")); // removes the offer if it's not from local area

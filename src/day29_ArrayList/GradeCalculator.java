...
public class GradeCalculator {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Total number of B: " + gradeOfA.size());
        System.out.println("Total number of C: " + gradeOfA.size());
        System.out.println("Total number of D: " + gradeOfA.size());
        System.out.println("Total number of F: " + gradeOfA.size());

...
public class IteratingMultiDimensionalArray2 {
    public static void main(String[] args) {
        ...
        for (int i = arr2D.length - 1; i >= 0; i--) { //i: index num of 1D arrays starting from last index to 0
            ...
            for (int j = 0; j < arr2D[i].length; j++) { //j: index num of elements starting from 0 to last index
        ...
        for (int i = 0; i < arr2D.length; i++) { //i: index of each 1D array started from 0
